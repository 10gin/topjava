...
public class JdbcMealRepository implements MealRepository {
    ...
    public Meal get(int id, int userId) {
        List<Meal> meals = jdbcTemplate.query("SELECT id as id, datetime as datetime, description as description, calories as calories FROM meals WHERE id=? and user_id=?", ROW_MAPPER, id, userId);
